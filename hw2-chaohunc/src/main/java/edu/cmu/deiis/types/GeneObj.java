 ...
 * XML source: /Users/chaohunc/Documents/workspace/hw2-chaohunc/src/main/resources/hw2-aeeDescriptor.xml
 * @generated */
public class GeneObj extends Annotation {
  ...
  */  
  ...
  public void setGeneName(String v) {
    if (GeneObj_Type.featOkTst && ((GeneObj_Type)jcasType).casFeat_geneName == null)
      jcasType.jcas.throwFeatMissing("geneName", "edu.cmu.deiis.types.GeneObj");
  ...
  public String getID() {
    if (GeneObj_Type.featOkTst && ((GeneObj_Type)jcasType).casFeat_ID == null)
      jcasType.jcas.throwFeatMissing("ID", "edu.cmu.deiis.types.GeneObj");
  ...
  public int getPosStart() {
    if (GeneObj_Type.featOkTst && ((GeneObj_Type)jcasType).casFeat_posStart == null)
      jcasType.jcas.throwFeatMissing("posStart", "edu.cmu.deiis.types.GeneObj");
  ...
  public int getPosEnd() {
    if (GeneObj_Type.featOkTst && ((GeneObj_Type)jcasType).casFeat_posEnd == null)
      jcasType.jcas.throwFeatMissing("posEnd", "edu.cmu.deiis.types.GeneObj");
  ...
  public double getConfidence() {
    if (GeneObj_Type.featOkTst && ((GeneObj_Type)jcasType).casFeat_confidence == null)
      jcasType.jcas.throwFeatMissing("confidence", "edu.cmu.deiis.types.GeneObj");
